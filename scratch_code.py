...
class ComprehensiveShatirDiagrams:
    ...
    def build_solar_diagram(self, sample_angle_deg=50.0):
        ...
        ax.text(68, 1.5, ar('خط الأوج (Apogee Line)'), fontsize=11, fontweight='bold', color='#1A365D')
        ...
        rules_text = ar(
            ...
            '3. فلك التدوير الثاني (r2): نصف قطره = 2;30 (2.5000) يدور بضعف زاوية المركز 2α.\n'
            '4. أقصى تعديل لمركز الشمس: درجتان ودقيقتان وست ثوان (2° 02m 06s).\n'
    ...
    def build_lunar_diagram(self):
        ...
        ax1.set_title(ar('أ. القمر في حالتي الاجتماع والاستقبال (Syzygy)\n[المحاق والبدر: زاوية الاستطالة 2η = 0°]'), fontsize=13, fontweight='bold', color='#1A365D', pad=15)
        ...
        ax2.set_title(ar('ب. القمر في حال التربيعين (Quadrature)\n[نصف القمر: زاوية الاستطالة 2η = 180° ومقارنة بطلميوس]'), fontsize=13, fontweight='bold', color='#1A365D', pad=15)
